...
| `list_collections` | Коллекции с организацией, числом элементов и доступом; в режиме admin — участники |
...
| `list_organizations` | Все организации сервера с участниками и владельцами |
...
| `delete_user` | Удалить аккаунт; в два шага, единственного владельца организации — отказ |
| `delete_organization` | Удалить организацию со всем содержимым; в два шага, с подтверждением по имени |
...
| `VWMCP_ORGANIZATION` | Нет | все | Организации, которыми управляет режим admin, имена или id через запятую |
...
| `VWMCP_INVITE_DOMAINS` | Нет | любые | Домены, которые могут приглашать `invite_member` и `invite_user` |
